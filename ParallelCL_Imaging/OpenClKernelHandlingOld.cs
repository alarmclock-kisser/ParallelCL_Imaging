...
{
	public class OpenClKernelHandlingOld
	{
		// ----- ----- ----- ATTRIBUTES ----- ----- ----- \\
		...
		// ----- ----- ----- CONSTRUCTOR ----- ----- ----- \\
		public OpenClKernelHandlingOld(OpenClContextHandling openClContextHandling)
		{
			// Set attributes
		...
		public string[] GetKernelPaths()
		{
			...
			string[] files = Directory.GetFiles(Path.Combine(this.Repopath, "Resources", "Kernels"), "*.k");
